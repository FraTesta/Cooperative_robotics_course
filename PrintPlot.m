...
% hplot2 = plot(plt.t, plt.jlmin);
% set(hplot2, 'LineWidth', 1);
legend('q_1','q_2','q_3','q_4','q_5','q_6','q_7','AutoUpdate','off');
if ACTIONS == 1
    hold on;
    xline(plt.changePhaseTime,'--r',{'Navigation',' Accomplished'});
end 
...
set(hplot, 'LineWidth', 1);
legend('qdot_1','qdot_2','qdot_3','qdot_4','qdot_5','qdot_6','qdot_7','AutoUpdate','off');
if ACTIONS == 1
    hold on;
    xline(plt.changePhaseTime,'--r',{'Navigation',' Accomplished'});
end 
...
set(hplot, 'LineWidth', 1);
legend('x','y','z','roll','pitch','yaw','AutoUpdate','off');
if ACTIONS == 1
    hold on;
    xline(plt.changePhaseTime,'--r',{'Navigation',' Accomplished'});
end 
...
legend('xdot', 'ydot','zdot','omega_x','omega_y','omega_z','AutoUpdate','off');
% 
% 
% figure(3);
