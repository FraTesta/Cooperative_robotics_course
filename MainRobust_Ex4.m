...
for t = 0:deltat:end_time
    ...
    % the sequence of iCAT_task calls defines the priority
     [Qp, ydotbar] = iCAT_task(uvms.A.vc_lin,  uvms.Jvc_lin,    Qp, ydotbar, uvms.xdot.vc_lin,  0.0001,   0.01, 10);
     [Qp, ydotbar] = iCAT_task(uvms.A.vc_ang,  uvms.Jvc_ang,    Qp, ydotbar, uvms.xdot.vc_ang,  0.0001,   0.01, 10); 
